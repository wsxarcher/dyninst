...
bool EmitterAMDGPUStat::emitPIC(codeGen& gen, Address origAddr, Address relocAddr) {
	assert(0);
	return false;
}
bool EmitterAMDGPUDyn::emitPIC(codeGen &gen, Address origAddr, Address relocAddr) {

 ...
 */
   ...
   return true;
#else
   /* XXX try to print the register name, check nesting to fix later */
	DYNINST_SUPPRESS_UNUSED_VARIABLE(regpool);
	assert(0 && "linux_thread::plat_getAllRegisters(int_registerPool &regpool) NOT IMPLEMENTED");
     
   pthrd_printf("ptrace not available, can't fetch Register\n");
   return false;
#endif
}
